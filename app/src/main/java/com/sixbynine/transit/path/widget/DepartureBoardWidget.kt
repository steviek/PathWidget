...
class DepartureBoardWidget @Inject internal constructor(
    ...
    override fun Content() {
        ...
        Column(
            modifier = GlanceModifier.drawableBackground(R.drawable.widget_background)
                .fillMaxSize(),
    ...
    fun SetupView() {
        Text(
            modifier = GlanceModifier
                ...
                .padding(16.dp),
            text = stringResource(R.string.complete_widget_setup),
            style = TextStyle(
    ...
    fun LoadingView() {
        ...
        Text(text = stringResource(R.string.loading), modifier = GlanceModifier.padding(top = 8.dp))
    }
